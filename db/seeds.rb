...
Patate.create(poid:20, sortes:"yukonGold")
Patate.create(poid:30, sortes:"yukonGold")
Patate.create(poid:40, sortes:"yukonGold")
Patate.create(poid:50, sortes:"yukonGold")
